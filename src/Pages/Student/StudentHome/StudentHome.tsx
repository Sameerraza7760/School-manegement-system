      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-md shadow-md transition duration-300 transform hover:scale-105 hover:bg-gray-100">
          ...
          <p className="text-gray-700 mb-2">
            <span className="font-medium text-gray-600">Name:</span> John Doe
          </p>
          <p className="text-gray-700 mb-2">
            <span className="font-medium text-gray-600">Roll Number:</span> 123456
          </p>
          <p className="text-gray-700">
            <span className="font-medium text-gray-600">Class:</span> 10th Grade
          </p>
        </div>
