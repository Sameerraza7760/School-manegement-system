...
const StudentComplain = () => {
    ...
    return (
        <div className="container mx-auto mt-8">
            ...
            <form onSubmit={handleComplainSubmit} className="max-w-md mx-auto bg-white p-6 rounded-md shadow-md">
                <div className="mb-4">
                    <label htmlFor="complainText" className="block text-gray-700 text-sm font-medium mb-2">
                        Your Complaint
                    </label>
                    <textarea
                        id="complainText"
