        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex justify-center">
            <input
              ...
              className="border border-gray-300 focus:outline-none focus:border-indigo-500 rounded-md px-4 py-2 mb-4"
            />
          </div>
          <div className="lg:w-2/3 w-full mx-auto overflow-auto">
            <table className="table-auto w-full text-left whitespace-no-wrap">
              <thead>
                <tr>
                  <th className="py-3 px-4 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">
                    ID
                  </th>
                  <th className="py-3 px-4 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">
                    Image
                  </th>
                  <th className="py-3 px-4 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">
                    Name
